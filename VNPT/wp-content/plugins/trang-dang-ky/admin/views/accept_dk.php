<script type="text/javascript">
	(function($){
		$(document).ready(function(){
			...
			$(".wait_dk").click(function(){
				$.ajax({
                    type : "post", //Phương thức truyền post hoặc get
                    dataType : "json", //Dạng dữ liệu trả về xml, json, script, or html
                    url : '<?php echo admin_url('admin-ajax.php');?>', //Đường dẫn chứa hàm xử lý dữ liệu. Mặc định của WP như vậy
                    data : {
                        action: "checkdk", //Tên action
                        info_dk : $(this).val(),//Biến truyền vào xử lý. $_POST['website']
                    },
                    context: this,
                    beforeSend: function(){
                        //Làm gì đó trước khi gửi dữ liệu vào xử lý
...
<div >
	...
	<table class="table " border="solid" style="border-collapse: collapse;border-width: 3px;">
		<tr style="border-bottom: solid">
			<th colspan="10" ><h2 align="center"><b> Danh sách Đăng Ký</b></h2></th>
		</tr>
		<tr >
			<th><b>ID</b></th>
			<th ><b>Tên KH</b></th>
...
<button  onclick="location.reload();" class="wait_dk" value='wait.php' >Wait</button>
<button  onclick="location.reload();" class="accept_dk" value='accpect.php' >Accept</button>
<button  onclick="location.reload();" class="cancel_dk" value='cancel.php' >Cancel</button>
<div id="result_dk">hehe</div>
